...
export const metadata = {
  ...
  description: "Bin Ali Medical Supplies Leading Healthcare Solutions in UAE is the premier provider of medical equipment, pharmaceutical products, and healthcare solutions.",
  keywords: "medical supplies UAE, healthcare equipment Dubai, pharmaceutical distributor, medical devices Abu Dhabi, hospital supplies, dental equipment, surgical instruments, laboratory consumables, medical technology UAE",
  ...
  openGraph: {
    ...
    title: "Bin Ali Medical Supplies | Leading Healthcare Solutions in UAE",
    description: "Premier provider of medical equipment, pharmaceutical products, and healthcare solutions in the UAE. Trusted by hospitals and healthcare facilities across the United Arab Emirates.",
    images: [
      {
  ...
  twitter: {
    ...
    creator: "@binalimed",
    title: "Bin Ali Medical Supplies | Leading Healthcare Solutions in UAE",
    description: "Premier provider of medical equipment, pharmaceutical products, and healthcare solutions in the UAE. Trusted by hospitals and healthcare facilities.",
    images: {
      url: "https://binalimed.com/images/hero-bg.jpg",
      alt: "Bin Ali Medical Supplies - Healthcare Solutions",
    },
  ...
  other: {
    ...
    'DC.subject': 'Medical Supplies, Healthcare Equipment, Pharmaceutical Distribution',
    'DC.description': 'Leading provider of medical equipment and healthcare solutions in UAE',
    ...
    "@graph": [
      {
        ...
        "description": "Leading provider of medical equipment, pharmaceutical products, and healthcare solutions in the United Arab Emirates.",
        "address": {
          "@type": "PostalAddress",
          "addressCountry": "AE",
          "addressRegion": "Dubai",
      ...
      },
      {
        ...
        "description": "Premier provider of medical equipment, pharmaceutical products, and healthcare solutions in the UAE.",
        "breadcrumb": {
      ...
      },
      {
        ...
        "description": "Distribution of high-quality medical equipment and supplies to healthcare facilities across the UAE.",
      ...
      },
      {
        ...
        "description": "Pharmaceutical product distribution and supply chain management for healthcare providers.",
