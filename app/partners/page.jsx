...
const partners = [
  { src: Logo1, alt: "Dr. Reddy's", name: "Dr. Reddy's Laboratories", category: "Pharmaceutical" },
  { src: Logo2, alt: "Descarga", name: "Descarga Medical", category: "Medical Equipment" },
  { src: Logo3, alt: "Group Partner 1", name: "Medical Solutions Inc.", category: "Healthcare" },
  { src: Logo4, alt: "Group Partner 2", name: "Healthcare Innovations", category: "Medical Technology" },
  { src: Logo5, alt: "Group Partner 3", name: "Bio Medical Corp", category: "Biotechnology" },
  { src: Logo6, alt: "Group Partner 4", name: "Advanced Diagnostics", category: "Diagnostics" },
  { src: Logo7, alt: "Group Partner 5", name: "Surgical Instruments Ltd", category: "Surgical Equipment" },
  { src: Logo8, alt: "Group Partner 6", name: "MedTech Solutions", category: "Medical Technology" },
  { src: Logo9, alt: "Group Partner 7", name: "Healthcare Systems", category: "Healthcare" },
  { src: Logo10, alt: "Group Partner 8", name: "Bio Innovations", category: "Biotechnology" },
  { src: Logo11, alt: "Group Partner 9", name: "Medical Devices Inc", category: "Medical Devices" },
  { src: Logo12, alt: "Group Partner 10", name: "Pharma Solutions", category: "Pharmaceutical" },
  { src: Logo13, alt: "Group Partner 11", name: "Diagnostic Tools", category: "Diagnostics" },
  { src: Logo14, alt: "Group Partner 12", name: "Surgical Tech", category: "Surgical Equipment" },
  { src: Logo15, alt: "Group Partner 13", name: "Health Innovations", category: "Healthcare" },
  { src: Logo16, alt: "Group Partner 14", name: "Medical Research", category: "Research" },
  { src: Logo17, alt: "Group Partner 15", name: "Bio Tech Solutions", category: "Biotechnology" },
  { src: Logo18, alt: "Group Partner 16", name: "Healthcare Products", category: "Healthcare" },
  { src: Logo19, alt: "Group Partner 17", name: "Medical Equipment Co", category: "Medical Equipment" },
  { src: Logo20, alt: "Group Partner 18", name: "Pharma Tech", category: "Pharmaceutical" },
  { src: Logo21, alt: "Medical Partner 305", name: "Advanced Medical", category: "Medical Equipment" },
  { src: Logo22, alt: "Medical Partner 306", name: "Healthcare Plus", category: "Healthcare" },
  { src: Logo23, alt: "Medical Partner 307", name: "Bio Medical Tech", category: "Biotechnology" },
  { src: Logo24, alt: "Medical Partner 308", name: "Diagnostic Solutions", category: "Diagnostics" },
  { src: Logo25, alt: "Medical Partner 309", name: "Surgical Systems", category: "Surgical Equipment" },
  { src: Logo26, alt: "Medical Partner 310", name: "Med Innovations", category: "Medical Technology" },
  { src: Logo27, alt: "Medical Partner 311", name: "Health Systems", category: "Healthcare" },
  { src: Logo28, alt: "Medical Partner 313", name: "Bio Solutions", category: "Biotechnology" },
  { src: Logo29, alt: "Medical Partner 314", name: "Medical Devices", category: "Medical Devices" },
  { src: Logo30, alt: "Medical Partner 315", name: "Pharma Innovations", category: "Pharmaceutical" },
  { src: Logo31, alt: "Medical Partner 316", name: "Diagnostic Tech", category: "Diagnostics" },
  { src: Logo32, alt: "Medical Partner 317", name: "Surgical Solutions", category: "Surgical Equipment" },
  { src: Logo33, alt: "Medical Partner 318", name: "Healthcare Tech", category: "Healthcare" },
  { src: Logo34, alt: "Medical Partner 319", name: "Medical Research", category: "Research" },
  { src: Logo35, alt: "Medical Partner 320", name: "Bio Technology", category: "Biotechnology" },
  { src: Logo36, alt: "Medical Partner 321", name: "Health Products", category: "Healthcare" },
  { src: Logo37, alt: "Medical Partner 322", name: "Medical Equipment", category: "Medical Equipment" },
  { src: Logo38, alt: "Medical Partner 323", name: "Pharma Systems", category: "Pharmaceutical" },
  { src: Logo39, alt: "Innate", name: "Innate Medical", category: "Medical Technology" },
  { src: Logo40, alt: "Istem", name: "Istem Healthcare", category: "Healthcare" },
  { src: Logo41, alt: "Merit Organics", name: "Merit Organics", category: "Biotechnology" },
  { src: Logo42, alt: "Mindray", name: "Mindray Medical", category: "Medical Equipment" },
  { src: Logo43, alt: "Primed", name: "Primed Solutions", category: "Medical Technology" },
  { src: Logo44, alt: "Rendition", name: "Rendition Medical", category: "Healthcare" }
];
    ...
    <section className="py-16 bg-gradient-to-br from-blue-50 to-white">
      <Container>
        ...
        >
          ...
          >
            We collaborate with leading healthcare companies worldwide to deliver excellence 
            in medical supplies and solutions. Our partnerships enable us to provide 
            cutting-edge technology and innovative healthcare products.
          </motion.p>
        </motion.div>
